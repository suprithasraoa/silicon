...
function bindChallanDetails()
{
 ...
 var cdate=str;
    ...
    document.getElementById('sTableRow').innerHTML="<thead><tr><th>#</th><th>Emp. Name</th><th>Amt</th><th>Tax Deducted Date</th><th>Income Tax</th><th>Challan Sl. No.</th><th>Action</th></tr></thead><tbody>";
    var slno=0;
	var ahref="";

    var url = "sub/bind_list.php?show=" +ddlshowval+"&txtdate="+txtdate+"&txtenddate="+txtenddate+"&cid=0&tbl=SalaryInformation&clientId="+txtclientId;
//alert(url);
    $.getJSON(url, function(result) {
    console.log(result);
    $.each(result, function(i, field) {
    ...
    $("#sTableRow").append("<tr><td>"+slno+"</td><td style='font-size: 11px;'>"+field.empname+"</td><td style='font-size: 13px;'>"+field.Amount+"</td><td style='font-size: 13px;'>"+TaxDeductedDate+"</td><td style='font-size: 13px;'>"+field.IncTax+"</td><td style='font-size: 13px;'>"+field.challanname+"</td><td>"+ahref);
                   ...
                   <div class="col-sm-6">
                    ...
                    <div class="form-group" id="gtxtPaidDate">
                     <label>Paid/Credited Date</label>
					   <input type="text" class="form-control" id="txtPaidDate" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask required onchange="bindotherdate();" />
