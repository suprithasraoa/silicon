...
.lb
{
	...
	var pkval=txtclientId;
	  var url = "sub/bind_list.php?cid="+pkval+"&tbl=Client&clientId="+txtclientId;
//	  alert(url);
  ...
  $.each(result, function(i, field) {
	  ...
	  $("#txtasstYearto").html(field.AsstYearTo);
	    $("#cmbStatus").html(field.DeductorStatus);
	 	  $("#cmbDeductorType").html(field.dedtype); 
                      ...
                      <label for="exampleInputEmail1">TAN Number : </label>
					   ...
					   <div class="col-sm-6">
					    <div class="form-group" id="gtxtfinancialYearto">
                             <label id="txttan" class="lb"></label>
                    </div>
					  </div>
                   				 	  <div class="col-sm-6">
