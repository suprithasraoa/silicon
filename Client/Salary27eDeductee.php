...
function bindChallanDetails()
{
 ...
 var cdate=str;
    ...
    var url = "sub/bind_list.php?show=" +ddlshowval+"&txtdate="+txtdate+"&txtenddate="+txtenddate+"&cid=0&tbl=SalaryInformation27e&clientId="+txtclientId;
//alert(url);
    $.getJSON(url, function(result) {
    console.log(result);
    $.each(result, function(i, field) {
	...
	{
		var txtclientId = $("#txtclientId").val();
		var url = "sub/bind_alltotal.php?Tname=SalaryInformation27e&clientId="+txtclientId;
//alert(url);
    $.getJSON(url, function(result) {
 ...
 // alert(dataString);
          ...
          //alert($.trim(data));
                ...
                window.location.href="Salary27eDeductee.php";  
...
<script>
 ...
 $("#update").css('display','block');
  ...
  $("#save").css('display','none');
   ...
   var txtclientId = $("#txtclientId").val();	
  var url = "sub/bind_list.php?cid="+pkval+"&tbl=SalaryInformation27e&clientId="+txtclientId;
  //alert(url);
  $.getJSON(url, function(result) {
  ...
  {
  var url = "sub/deletecommon.php?pkvId="+pkval+"&Tname=SalaryInformation27e";
  //alert(url);
  $.getJSON(url, function(result) {
...
<section class="content">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">27EQ Collection Details</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form">
	 ...
	 $query ="SELECT Salary27eCtr FROM Parameter where  ClientId='".$_SESSION["loginId"]."'";

 $result = mysqli_query($dbcon,$query);
   while($row=mysqli_fetch_array($result)){                                                 
   $salctr=$row['Salary27eCtr'];  
  }
?>
 ...
 <div class="col-sm-6">
		  ...
		  <div class="col-lg-12">
				  ...
				  <div class="alert alert-success alert-dismissable" id="alert-success" style="display:none;">
                    ...
                    <h6>	<i class="icon fa fa-check"></i> Collection Details Details Submitted Successfully!</h6>
                    </div>
                  </div>
			</div>
     ...
     <input type="hidden" class="form-control" id="txtclientId" value=<?php echo $_SESSION["loginId"];  ?> >
		   ...
		   <div class="box">
				   ...
				   <div class="col-lg-3 ">
                  <h3 class="box-title">View Collection Details</h3>
