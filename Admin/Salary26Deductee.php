...
function bindCounter(){
	...
	$("#gtxtClientId").attr('class', 'form-group');
		 ...
		 var url = "sub/get_Counter.php?field=" +txtClientId;
//alert(url);
...
if	(txtClientId==null)	{
    ...
    var url = "sub/bind_list.php?show=" +ddlshowval+"&txtdate="+txtdate+"&txtenddate="+txtenddate+"&cid=0&tbl=SalaryInformation26&CltId="+txtClientId+"&userid="+userid;
    $.getJSON(url, function(result) {
    console.log(result);
    $.each(result, function(i, field) {
    var id= field.Id;
...
//alert(url);
  ...
  document.getElementById("lblrec").innerHTML=cnt;
	...
	$("#gtxtClientId").attr('class', 'form-group');
		 var txtClientId = $("#txtClientId").val();  
		 var url = "sub/get_Counter.php?ctr=Salary26Ctr&field=" +txtClientId;
//alert(url);
    $.getJSON(url, function(result) {
    console.log(result);
    $.each(result, function(i, field) {
    var Salary26Ctr= field.Salary26Ctr;
	$("#txtSerialNo").val(Salary26Ctr);
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">26Q Salary Information</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form">
