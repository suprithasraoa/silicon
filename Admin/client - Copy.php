...
//alert(url);
  ...
  document.getElementById("lblrec").innerHTML=cnt;
    ...
    document.getElementById('sTableRow').innerHTML="<thead><tr><th>#</th><th>User</th><th>Name</th><th>Designation</th><th>PAN</th><th>Mobile</th><th>Email Id</th><th>Action</th></tr></thead><tbody>";
    var slno=0;
  var ahref="";
...
?>
                  ...
                  <div class="form-group" id="gcmbTan">
                    ...
                    <label id="lblinvalidTan" style="color:red;display:none;">Invalid TAN Format</label>
                      ...
                      <label for="exampleInputEmail1">Financial Year
                      <span style="color:red;">*</span></label>
                     <input type="Number" class="form-control pull-right" id="txtfinancialYearfrm" placeholder="From" onchange="validte(this.value.length,'gtxtfinancialYearfrm')"/>
					 ...
					 <input type="Number" class="form-control pull-right" id="txtfinancialYearto" placeholder="To" onchange="validte(this.value.length,'gtxtfinancialYearto')"/>
                    </div>
					  </div>
                  </div>
				  ...
				  <div class="col-sm-12 nopad">
                   ...
                   <div class="col-sm-3">
                    <div class="form-group" id="gtxtasstYearfrm">
                      ...
                      <input type="Number" class="form-control pull-right" id="txtasstYearfrm" placeholder="From"  onchange="validte(this.value.length,'gtxtasstYearfrm')"/>
                    ...
                    <div class="form-group" id="gtxtasstYearto">
                                                <label style="color:white;">s</label>
					    <input type="Number" class="form-control pull-right" id="txtasstYearto" placeholder="To"  onchange="validte(this.value.length,'gtxtasstYearto')"/>
                    </div>
                  </div>
				   </div>
                   <div class="col-sm-6">
				   ...
				   <div class="col-sm-4">
                    <div class="form-group" id="gtxtPincode">
                      <label for="exampleInputPassword1">Pincode<span style="color:red;">*</span></label>
                            <input type="Number" class="form-control" id="txtPincode" placeholder="Enter Pincode"  onchange="validte(this.value.length,'gtxtPincode')">
                    </div>
                  </div>
				   <div class="col-sm-3">
                    <div class="form-group">
                    ...
                    <div class="form-group" id="gtxtPhone">
                      <label for="exampleInputPassword1">Phone No.</label>
                            <input type="Number" class="form-control" id="txtPhoneNo" placeholder="Enter Phone No." onchange="validte(this.value.length,'gtxtPhone')">
                    </div>
                  </div>
				  <div class="col-sm-4">
                    <div class="form-group">
...
?>
				   ...
				   <div class="col-sm-6">
                    <div class="form-group" id="gtxtRPincode">
                      <label for="exampleInputPassword1">Pincode<span style="color:red;">*</span></label>
                            <input type="Number" class="form-control" id="txtRPincode" placeholder="Enter Pincode" onchange="validte(this.value.length,'gtxtRPincode')">
                    </div>
                  </div>
				   <div class="col-sm-6">
