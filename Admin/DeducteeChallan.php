 ...
 bindgrid();
  ...
  function bindCounter(){
	...
	$("#gtxtClientId").attr('class', 'form-group');
		 ...
		 var url = "sub/get_Counter.php?ctr=DeducteeChallanCtr&field=" +txtClientId;
//alert(url);
    $.getJSON(url, function(result) {
    console.log(result);
    $.each(result, function(i, field) {
    var DeducteeChallanCtr= field.DeducteeChallanCtr;
	$("#txtSerialNo").val(DeducteeChallanCtr);
...
if	(txtClientId==null)	{
    ...
    document.getElementById('sTableRow').innerHTML="<thead><tr><th>#</th><th>User</th><th>Client</th><th>Inc. Tax</th><th>DeducteeChallan No.</th><th>Date</th><th>BSR Code</th><th>Action</th></tr></thead><tbody>";
    var slno=0;
	var ahref="";
 var txtclientId = $("#txtclientId").val();
    var url = "sub/bind_list.php?show=" +ddlshowval+"&txtdate="+txtdate+"&txtenddate="+txtenddate+"&cid=0&tbl=DeducteeChallan&CltId="+txtClientId+"&userid="+userid;
//alert(url);
    $.getJSON(url, function(result) {
    console.log(result);
    $.each(result, function(i, field) {
