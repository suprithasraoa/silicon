  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="../index2.html"><b>Silicon</b> User</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <div>
          <div class="form-group has-feedback">
            <input type="number" class="form-control" placeholder="Mobile Number"  name="users_email" id="users_email" required/>
...
$query = "SELECT * FROM dbsilicon.User Where Phone='".$_POST["users_email"]."'  and Password='".$_POST["users_pass"]."'";  
//echo($query);
//exit;
