...
<section class="content">
       ...
       <input type="hidden" id="txtclienId"/>
                 ...
                 <input type="text" class="form-control" id="txtTaskdate" placeholder="dd/mm/yyyy" onchange="validte(this.value.length,'gtxtTaskdate')"/> </div>
					</div>
					 <div class="col-sm-4">
                    <div class="form-group">
                      <label>Status<span style="color:red;">*</span></label><br>
              <label><input type="checkbox" name="txtstatus1" value="1">Done</label> </div>
					</div>
					</div>
					  <div class="col-sm-12 nopad">
					 <div class="col-sm-8">
                    <div class="form-group"  id="gtxtTaskdate">
                      <label>Entry & e-return Date<span style="color:red;">*</span></label>
                 <input type="text" class="form-control" id="txtTaskdate" placeholder="dd/mm/yyyy" onchange="validte(this.value.length,'gtxtTaskdate')"/>
                    ...
                    <div class="form-group">
                      <label>Status<span style="color:red;">*</span></label><br>
              <label><input type="checkbox" name="txtstatus2" value="1">Done</label> </div>
					</div>
					</div>
					  <div class="col-sm-12 nopad">
					<div class="col-sm-8">
                    <div class="form-group"  id="gtxtTaskdate">
                      <label>Form 27A & Bill Sending Date<span style="color:red;">*</span></label>
                 <input type="text" class="form-control" id="txtTaskdate" placeholder="dd/mm/yyyy" onchange="validte(this.value.length,'gtxtTaskdate')"/>
				 </div>
					</div>
					 <div class="col-sm-4">
                    <div class="form-group">
                      <label>Status<span style="color:red;">*</span></label><br>
              <label><input type="checkbox" name="txtstatus3" value="1">Done</label> </div>
					</div>
					</div>
					  <div class="col-sm-12 nopad">
					<div class="col-sm-8">
                    <div class="form-group"  id="gtxtTaskdate">
                      <label>Recieving of Signed Form 27A & Bill Amount Date<span style="color:red;">*</span></label>
                 <input type="text" class="form-control" id="txtTaskdate" placeholder="dd/mm/yyyy" onchange="validte(this.value.length,'gtxtTaskdate')"/>
					   </div>
					</div>
					 <div class="col-sm-4">
                    <div class="form-group">
                      <label>Status<span style="color:red;">*</span></label><br>
              <label><input type="checkbox" name="txtstatus4" value="1">Done</label> </div>
					</div>
					</div>
					  <div class="col-sm-12 nopad">
					<div class="col-sm-8">
                    <div class="form-group"  id="gtxtTaskdate">
                      <label>Uploading of FVU File Date<span style="color:red;">*</span></label>
                 <input type="text" class="form-control" id="txtTaskdate" placeholder="dd/mm/yyyy" onchange="validte(this.value.length,'gtxtTaskdate')"/>
					  </div>
					</div>
					 <div class="col-sm-4">
                    <div class="form-group">
                      <label>Status<span style="color:red;">*</span></label><br>
              <label><input type="checkbox" name="txtstatus5" value="1">Done</label> </div>
					</div>
					</div>
					  <div class="col-sm-12 nopad">
					<div class="col-sm-8">
                    <div class="form-group"  id="gtxtTaskdate">
                      <label>Sending PR to Customer Date<span style="color:red;">*</span></label>
                 <input type="text" class="form-control" id="txtTaskdate" placeholder="dd/mm/yyyy" onchange="validte(this.value.length,'gtxtTaskdate')"/>
					</div>
					</div>
					 <div class="col-sm-4">
                    <div class="form-group">
                      <label>Status<span style="color:red;">*</span></label><br>
              <label><input type="checkbox" name="txtstatus6" value="1">Done</label> </div>
					</div>
					</div>
					    <div class="col-sm-12 nopad">
					  <div class="col-sm-6">
