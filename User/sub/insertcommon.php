...
else
{
    ...
    `NameInitial`,	
	`Name`, 
	`FathersName`,`ResidentialStatus`,`Address1`,`Address2`,`Address3`,`City`,`State`,`Pincode`,`DOB`,
...
//echo $insert_user; exit;
	...
	$last_id = mysqli_insert_id($dbcon);
			mysqli_query($dbcon,"insert into dbsilicon.Parameter (`ClientId`)values('$last_id')");
