...
//Employee
	...
	`FathersName`='".$_GET["txtFatherName"]."', 
...
$qryres="update Task set `CompletedByUserId`='".$_GET["userid"]."',`DateComplete` = '$dte', `Status`='".$_GET["txtStatus"]."' where Task.Id='".$_GET["pkvId"]."'";
}else{
$qryres="update Task set `CompletedByUserId`='".$_GET["userid"]."',`Status`='".$_GET["txtStatus"]."' where Task.Id='".$_GET["pkvId"]."'";	
}
